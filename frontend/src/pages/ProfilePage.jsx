      ...
      <div className="bg-white border-b border-teal-100 px-8 py-6 shadow-sm">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm mt-1">Manage your account and health information</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white border-b border-teal-100 px-8">
        <div className="flex gap-8">
          {[
            ...
            { id: 'health', label: 'Health History', icon: '📋' },
        ...
        <div className="max-w-4xl mx-auto p-8">
            ...
            <div className="space-y-6">
                ...
                {editMode ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <p className="text-lg font-semibold text-gray-900 mt-1">{formData.firstName || 'Not provided'}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-lg font-semibold text-gray-900 mt-1">{formData.phone || 'Not provided'}</p>
                    </div>
                    <div>
                      <p className="text-sm font-medium text-gray-600 uppercase tracking-wide">Blood Type</p>
                      <p className="text-lg font-semibold text-gray-900 mt-1">{formData.bloodType || 'Not provided'}</p>
                    </div>
                  </div>
                )}
              </div>
              ...
              <div className="grid grid-cols-3 gap-4">
                {[
                  ...
                  { label: 'Joined', value: '3 months ago', icon: '📅' },
                  { label: 'Risk Level', value: 'Excellent', icon: '✅' },
                ].map((stat, idx) => (
          ...
          {activeTab === 'health' && (
            <div className="space-y-4">
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Health Consultation History</h2>
              ...
              {loading ? (
                ...
                <div className="card-light text-center py-12">
                  <p className="text-gray-600 text-lg">No consultation history yet</p>
                  ...
                  {[
                    {
                      ...
                      desc: 'Receive updates about your health consultations',
                      icon: '📧'
                    },
                    {
                      key: 'pushNotifications',
                      label: 'Push Notifications',
                      desc: 'Get instant alerts for urgent health updates',
                      icon: '🔔'
                    },
                    {
                      key: 'weeklyReport',
                      label: 'Weekly Health Report',
                      desc: 'Receive a summary of your health activities',
                      icon: '📊'
                    },
